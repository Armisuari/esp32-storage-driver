...
{   
    ...
    private:
    ...
    #if STORAGE_ENABLE_VERSIONING
        std::unique_ptr<file_versioning> versioning;
        ...
        bool read_file_internal(const std::string& key, void* data, size_t data_size);
        bool write_file_internal(const std::string& key, const void* data, size_t data_size);
        bool write_file_no_mutex(const std::string& key, const void* data, size_t data_size);
        bool read_file_no_mutex(const std::string& key, void* data, size_t data_size);
};